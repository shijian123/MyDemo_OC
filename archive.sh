...
#setting_path=/Users/huyunlong/Desktop/WallPaper的副本/setting.plist
...
# 项目路径 workspace路径
project_path=$(/usr/libexec/PlistBuddy -c "print project_path" ${setting_path}) workspace_path="${project_path}/${project_name}.xcworkspace"
...
"$altoolPath" --validate-app -f ${ipa_path}/${ipa_name}.ipa -u luolanlan007@163.com -p Zhangzhihan0822 -t ios --output-format xml
"$altoolPath" --upload-app -f ${ipa_path}/${ipa_name}.ipa -u luolanlan007@163.com -p Zhangzhihan0822 -t ios --output-format xml
else
echo "地址：-----@${ipa_path}/${ipa_name}.ipa"
