...
@interface CYPlayerResourceLoader ()
@property (nonatomic, strong) NSMutableArray<AVAssetResourceLoadingRequest *> *requestList;
@property (nonatomic, strong) CYPlayerRequestManager *requestManager;

@end

@implementation CYPlayerResourceLoader
...
- (void)newTaskWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest cache:(BOOL)cache {
    ...
    self.requestManager = [[CYPlayerRequestManager alloc] initWithUrl:loadingRequest.request.URL];
...
- (BOOL)finishLoadingWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest {
    ...
    //    [loadingRequest.dataRequest respondWithData:[CYPlayerFileManager CY_readTempFileDataWithOffset:requestedOffset - self.requestManager.requestOffset length:respondLength]];
    [loadingRequest.dataRequest respondWithData:[CYPlayerFileManager cy_readTempFileDataWithOffset:requestedOffset length:respondLength]];
