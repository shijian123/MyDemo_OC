...
{
    [super viewDidLoad];
    self.viewContainer.width = MainScreenWidth;
    self.viewContainer.height = MainScreenHeight;
    self.view.width = MainScreenWidth;
    self.view.height = MainScreenHeight;
...
- (void)setupCaptureVideoPreviewLayer
{
    ...
    [_captureVideoPreviewLayer addSublayer:view.layer];
    [_captureVideoPreviewLayer addSublayer:lab.layer];
}
