...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        lineView.backgroundColor = [UIColor colorWithHex:0xe1e1e5];
        ...
        CGFloat itemW = 62;
        CGFloat itemH = 37;
        UIImage *image = [UIImage imageWithColor:[UIColor colorWithHex:0xf2f2f6]];
...
//
        ...
        [sendButotn setTitleColor:[UIColor colorWithHex:0xffffff] forState:UIControlStateNormal];
        [sendButotn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHex:0x4285f4 alpha:0.3]] forState:UIControlStateHighlighted];
        [sendButotn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHex:0x4285f4]] forState:UIControlStateNormal];
...
- (void)setupInit {
    self.view.backgroundColor = [UIColor colorWithHex:0xf2f2f6];
...
- (UIPageControl *)pageControl {
    if (!_pageControl) {
        ...
        _pageControl.pageIndicatorTintColor = [UIColor colorWithHex:0xe3e3e8];
        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithHex:0xbababf];
    }
    return _pageControl;
}
...
- (KeyboardToolBar *)toolBarView {
    if (!_toolBarView) {
        ...
        _toolBarView.backgroundColor = [UIColor colorWithHex:0xffffff];
    }
    return _toolBarView;
}
