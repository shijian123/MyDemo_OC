...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _textLabel.textColor = [UIColor colorWithHex:0x1d1d1d];
...
+ (NSAttributedString *)processModel:(LHMessageModel *)model {
    ...
    NSDictionary *attri = [NSDictionary dictionaryWithObjects:@[[UIFont systemFontOfSize:15],model.isSender ? [UIColor whiteColor] : [UIColor colorWithHex:0x47474a],paragraphStyle] forKeys:@[NSFontAttributeName,NSForegroundColorAttributeName,NSParagraphStyleAttributeName]];
