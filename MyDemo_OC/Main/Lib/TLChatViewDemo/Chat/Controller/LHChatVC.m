...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    UIView *refreshView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth, 40)];
    UIActivityIndicatorView *activityIndicatorView = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake((MainScreenWidth - 15) * 0.5, (20 - 15) * 0.5, 15, 15)];
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNavBarHeight, MainScreenWidth, MainScreenHeight - kChatBarHeight - kNavBarHeight) style:UITableViewStyleGrouped];
...
- (LHChatBarView *)chatBarView {
    if (!_chatBarView) {
        CY_WeakSelf;
        _chatBarView = [[LHChatBarView alloc] initWithFrame:CGRectMake(0, MainScreenHeight - kChatBarHeight, MainScreenWidth, kChatBarHeight)];
        _chatBarView.backgroundColor = [UIColor colorWithHex:0xf8f8fa];
