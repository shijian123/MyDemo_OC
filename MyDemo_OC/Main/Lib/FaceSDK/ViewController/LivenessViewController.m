        ...
        switch (remindCode) {
            case LivenessRemindCodeOK: {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [CYNotificationCenter postNotificationName:CYFaceIDImageKey object:selectedImage];
            ...
            case LivenessRemindCodeTimeout: {
                dispatch_async(dispatch_get_main_queue(), ^{
                    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"" message:@"验证超时" preferredStyle:UIAlertControllerStyleAlert];
