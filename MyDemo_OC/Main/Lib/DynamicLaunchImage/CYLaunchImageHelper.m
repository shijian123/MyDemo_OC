...
#import "CYDynamicLaunchImage.h"
#import <ImageIO/ImageIO.h>

@implementation CYLaunchImageHelper
...
+ (void)changeAllLaunchImageToPortrait:(UIImage *)image {
    ...
    [CYDynamicLaunchImage replaceLaunchImage:image];
}
...
+ (void)changePortraitLaunchImage:(UIImage *)portraitImage
    ...
    [CYDynamicLaunchImage replaceLaunchImage:portraitImage compressionQuality:0.8 customValidation:^BOOL(UIImage *systemImage, UIImage *yourImage) {
    ...
    [CYDynamicLaunchImage replaceLaunchImage:landscapeImage compressionQuality:0.8 customValidation:^BOOL(UIImage *systemImage, UIImage *yourImage) {
        return [self checkImage:systemImage sizeEqualToImage:yourImage];
    }];
}
