...
extern NSString *const FCUUIDsOfUserDeviceDidChangeNotification;

@interface JKUUID : NSObject
{
    ...
    NSString *_uuidsOfUserDevice;
    BOOL _uuidsOfUserDevices_CloudAvailable;
}
