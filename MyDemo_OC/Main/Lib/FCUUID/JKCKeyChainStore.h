...
extern NSString * const JKCKeyChainStoreErrorDomain;
...
@interface JKCKeyChainStore : NSObject
...
+ (JKCKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service;
+ (JKCKeyChainStore *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
@interface JKCKeyChainStore (ErrorHandling)
...
@interface JKCKeyChainStore (ForwardCompatibility)
...
@interface JKCKeyChainStore (Deprecation)
