...
#import "CYFaceBeautyController.h"
...
@interface CYFaceBeautyController ()<CAAnimationDelegate> {
    CGFloat _allTime;
    UIImage *_tempImg;
...
@implementation CYFaceBeautyController
...
- (void)setupUI {
    ...
    gobackBtn.frame = CGRectMake(20, 40, 60, 40);
    [gobackBtn setTitle:@"返回" forState:UIControlStateNormal];
    [gobackBtn addTarget:self action:@selector(goBackMethod) forControlEvents:UIControlEventTouchUpInside];
